...
#define  includeTaskRestart                      demoUseShared
...
#define  CapabilitiesOverride                    cfgCapDelay
...
#define  StackSizeOS                             8 + 4*defThreeByteStackAdd
#define  StackSizeISR                            0
#if (demoUseShared == cfgTrue)
  #define  StackSizeShared                       4 + 2*defThreeByteStackAdd
  #define  StackSizeOverride                     cfgShared
#else
  #define  StackSizeShared                       0
  #define  StackSizeOverride                     4 + 2*defThreeByteStackAdd
#endif

#else

#define  StackSafety                             2
#define  StackSizeOS                             32 + 8*defThreeByteStackAdd
#define  StackSizeISR                            0
#if (demoUseShared == cfgTrue)
  #define  StackSizeShared                       6 + 2*defThreeByteStackAdd
  #define  StackSizeOverride                     cfgShared
#else
  #define  StackSizeShared                       0
  #define  StackSizeOverride                     6 + 2*defThreeByteStackAdd
#endif
...
#define  RegisterUseOverride                     registersNon
...
#define  RegisterCheckOverride                   registersNon
...
#define  InterruptStartOverride                  cfgGlobClear | cfgTickClear
