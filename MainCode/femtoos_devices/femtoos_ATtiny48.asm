...
#define devRAMend         0x0200
#define devFLASHsize      0x0800U
#define devEEPROMsize     0x0040U
...
#define devSigTimerCompare     TIMER0_COMPA_vect
 ...
 */
  ...
  /* Catch the watchdog interrupt here 0x0007. */
  ...
  __do_clear_bss:
    ...
    rjmp __do_clear_bss_ext
  __interrupt_timer0_vector_definition:
  /* Catch the timer compare interrupt here 0x00C. */
    rjmp privTickYield
  __do_clear_bss_ext:
