...
#define devRAMbegin       0x0200
#define devRAMend         0x2200
#define devFLASHsize      0x10000UL
#define devEEPROMsize     0x1000U
 ...
 *
 * Note: we may question the relevance of this approach for this large device. However,
 * since is more easy in testing to treat all devices on an equal footing, i did still
 * define the routine below.
 */
  ...
  /* You may define here your PCINTx handlers. */
    nop
    nop
    nop
  /* Catch the watchdog interrupt here 0x0018 */
  ...
  __do_copy_data:
    ...
    nop
    nop
  /* Catch the timer compare interrupt here.0x002A*/
    jmp privTickYield
